...
public class Level_3_Page_Object_pattem  {
	...
	Assert.assertEquals(loginPage.getEmailAdressInvalidErrorMessage(), "Please enter a valid email address. For example johndoe@domain.com.");
  }
