...
public class HomePageObject extends BasePage {
	...
	// Nếu như mình không viết rõ hàm khởi tạo thì trong quá trình chạy nó sẽ gọi
	// đến hàm khởi tạo
	// mặc định của Class đó (hàm khởi tạo rỗng: tên hàm/ ko có phần thân

	// Truy cập đến biến thuộc phạm vi Class (global trong case trùng tên với biến
	// thuộc phạm vi hàm (local)
	WebDriver driver;
