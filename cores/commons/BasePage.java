...
public class BasePage {
	...
	// getXXX: getCurrentUrl/ getTitle/ getCssValue/ getTexxt/getAttribute/
	// getSize/...
	// 3 - Tên hàm:
	...
	// Khai báo 1 biến bên trong:Kiểu dữ liệu - tên dữ liệu: String addressName,
	// String pageUrl
	...
	/* WebElement */
	// Note:
	// 1 - Tham số đầu tiên thuộc của 1 hàm tương tác vs Web Browser là "WebDriver
	// driver"
	// 2- Tham số thứ hai bắt buộc của 1 hàm tương tác với web Browser là "String
	// locator"
